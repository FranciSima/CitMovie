						...
						<h3><?php echo $movie['movie_name']; ?></h3>	
							<div class="about-top">	
								...
								<div class="desc span_3_of_2">
									...
									<a href="player.php?movie=<?php echo urlencode($_SESSION['movie']); ?>" target="_blank" class="watch_but">View Movie</a>
								</div>
								<div class="clear"></div>
							</div>
							<table class="table table-hover table-bordered text-center" id="movieDetails">
							<?php
